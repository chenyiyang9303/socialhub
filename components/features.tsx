...
export function Features() {
  return (
    ...
    >
      ...
      Managing social media can be a complex task that requires a variety of
      skills to become successful. But we have got you covered!
      </p>
  ...
  if (!isClient) {
    ...
    return (
      <div
        ...
        className={cn("bg-neutral-100 dark:bg-neutral-800 rounded-full", className)}
      />
    );
  }
