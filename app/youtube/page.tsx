          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="relative">
                <Image
                  src="/platform/youtube/imgi_3_video-scheduling.webp"
                  alt="YouTube Video Scheduling"
                  width={600}
                  height={400}
        ...
        <Container>
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative">
                <Image
                  src="/platform/youtube/imgi_4_post-review.webp"
        ...
        <Container>
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="relative">
                <Image
                  src="/platform/youtube/imgi_5_social-calendar.webp"
                  alt="YouTube Content Calendar"
                  width={600}
                  height={400}
                  className="rounded-2xl shadow-2xl"
                />
        ...
        <Container>
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative">
                <Image
                  src="/platform/youtube/imgi_6_video-post.webp"
                  alt="YouTube Video Management"
                  width={600}
                  height={400}
                  className="rounded-2xl shadow-2xl"
                />
